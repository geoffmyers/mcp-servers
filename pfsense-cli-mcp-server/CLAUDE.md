---
title: CLAUDE.md - pfSense CLI MCP Server
created: 2026-02-26
modified: 2026-02-26
description: "MCP server wrapping pfSense CLI tools (pfctl, pfSsh.php, FreeBSD utilities) for firewall, network, service, DNS, and VPN management. Supports local or SSH execution via @geoffmyers/mcp-server-shared...."
