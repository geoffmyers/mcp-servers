---
title: CLAUDE.md - Docker CLI MCP Server
created: 2026-02-26
modified: 2026-02-26
description: "MCP server wrapping the Docker CLI for container, image, volume, network, and Compose management. Supports local or SSH execution via @geoffmyers/mcp-server-shared. Provides 35 tools, 2 resources,..."
