---
title: CLAUDE.md - MCP Servers
created: 2026-03-01
modified: 2026-03-01
description: Custom Model Context Protocol servers for infrastructure management and CLI tool access. All servers are TypeScript/Node.js with dual transport support (stdio for Claude Code, streamable HTTP for web clients).
...
| truenas-cli | TrueNAS SCALE CLI via midclt | 43 | 3 | 2 | 3023 |
