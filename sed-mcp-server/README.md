---
title: Sed MCP Server
created: 2026-02-06
modified: 2026-02-06
description: A Model Context Protocol (MCP) server wrapping the Unix sed command. Provides structured tools for text substitution and line extraction with built-in safety features (preview mode and automatic...
