...
created: 2026-02-06
modified: 2026-02-06
description: "A Model Context Protocol (MCP) server wrapping the Unix find command. Provides structured tools for searching files and directories by name, type, size, modification time, and content from any..."
