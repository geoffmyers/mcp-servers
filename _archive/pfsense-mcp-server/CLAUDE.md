---
title: CLAUDE.md - pfSense MCP Server
created: 2026-02-06
modified: 2026-02-06
description: "MCP server for managing pfSense+ firewalls via the REST API v2. Provides 34 tools, 5 resources, and 3 prompts for firewall rules, NAT/port forwarding, aliases, interfaces, services (DHCP, DNS), VPN..."
