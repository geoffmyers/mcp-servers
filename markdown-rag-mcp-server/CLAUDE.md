---
title: CLAUDE.md - Markdown RAG MCP Server
created: 2026-05-18
modified: 2026-05-18
description: "MCP server providing semantic + hybrid search over the repo's markdown knowledge base via self-hosted Qdrant + Ollama embeddings. Default port 3028."
tags: [mcp-servers, claude, rag, knowledge-base]
---
