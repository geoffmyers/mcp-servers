---
title: CLAUDE.md - Rsync MCP Server
created: 2026-02-06
modified: 2026-02-06
description: "MCP server wrapping the Unix rsync command. Provides 2 tools and 1 prompt for file synchronization and transfer with a dry-run-first safety workflow. Supports archive mode, compression,..."
