---
title: CLAUDE.md - ESPHome CLI MCP Server
created: 2026-02-26
modified: 2026-02-26
description: "MCP server wrapping the ESPHome CLI for device configuration management, firmware compilation, and log monitoring. Supports local or SSH execution via @geoffmyers/mcp-server-shared. Provides 10 tools,..."
