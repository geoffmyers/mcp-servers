...
created: 2026-02-06
modified: 2026-02-06
description: "A Model Context Protocol (MCP) server wrapping the Unix xargs command. Provides a structured tool for executing batch commands with arguments built from input items, with a command allowlist for..."
